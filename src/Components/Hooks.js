...
const [myself,Setmyself] = useState({
    ...
    says:"Good Morning",
    name:"Balaji",
    image:'https://fiverr-res.cloudinary.com/images/q_auto,f_auto/gigs/200355617/original/57e33b448a8da9664e391a3b4e4d2f50e1d67dbe/be-your-front-end-developer.jpg'
...
<div class="card cardC" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">{myself.says},Hello {myself.name}</p>
